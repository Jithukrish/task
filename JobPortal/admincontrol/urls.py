...
urlpatterns = [
    ...
    path('header_edit/<int:pk>/',views.HeaderEditView.as_view(),name="header_edit"),
    path('header_list/',views.HeaderlistView.as_view(),name="header_list"),
    ...
    path('selected_jobs/', UserDetailView.as_view(), name='selected_jobs'),
    path('section_first/', views.SectionView.as_view(), name='section_first'),
    path('about_us/', views.AboutUsFormView.as_view(), name='about_us'),
    path('about_us_list/', views.AboutUsListView.as_view(), name='about_us_list'),
    path('about_us_delete/<int:pk>/', views.aboutusDeleteView.as_view(), name='about_us_delete'),
    path('about_us_update/<int:pk>/', views.UpdateAboutUsView.as_view(), name='about_us_update'),
    path('about_update/', views.UpdateaboutProfileView.as_view(), name='about_update'),
    ...
    path('company_logo_delete/<int:pk>/', views.MenfrequentDeleteView.as_view(), name='company_logo_delete'),
    ...
    path('contact_section/', views.FrequentSectionView.as_view(), name='contact_section'),
    path('frequency_asked_list/', views.FrequencyListView.as_view(), name='frequency_asked_list'),
    path('frequency_asked_edit/<int:pk>/', views.frequentlyUpdateView.as_view(), name='frequency_asked_edit'),
    path('frequency_asked_delete/<int:pk>/', views.frequentDeleteView.as_view(), name='frequency_asked_delete'),
